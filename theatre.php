...
<div class="body-container container-fluid">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-10 col-md-9 col-12 body_block  align-content-center">
         ...
         <font size=25px>The Movie theatre's nearby are:</font>
	<div class=list>
	<ol>
		<div id=lis>
		</div>
...
var add=[];
var d="";
var addr="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+lat+","+lon+"&radius=9000&type=movie_theater&keyword=&key=AIzaSyAUxpONmjvDKbyWoEmPbE7UfOC-E0-uAjI";
$.ajax({
  url:addr,
